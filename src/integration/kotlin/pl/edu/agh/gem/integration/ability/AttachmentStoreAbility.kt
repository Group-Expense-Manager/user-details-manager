...
private fun createDefaultAttachmentIdUrl() = "$INTERNAL/attachments"

fun stubDefaultAttachmentIdUrl(body: Any?, statusCode: HttpStatusCode = OK) {
    wiremock.stubFor(
        get(urlMatching(createDefaultAttachmentIdUrl()))
            .willReturn(
                aResponse()
